...
const Feedback = () => {
  return (
    <div className="relative flex justify-center mb-12 md:mb-24 lg:mb-96">
      <div className="w-full md:w-[720px] lg:w-[1280px] h-[242px] md:h-[322px] lg:h-[442px] bg-cyan-50 rounded-[20px] md:rounded-[40px] lg:rounded-[60px] relative overflow-hidden">
        <div className="w-full h-full flex justify-center items-center flex-col">
          ...
          <div className="w-[320px] md:w-[520px] lg:w-[620px] text-center text-black text-opacity-60 text-base md:text-lg lg:text-xl font-normal font-inter leading-7 mt-4 md:mt-8 lg:mt-12">
            Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod
            tempor incididunt ut labore et dolore magna aliqut enim ad minim
          </div>
          <div className="flex w-full md:w-[480px] h-20 bg-white rounded-3xl justify-between items-center px-2 mt-4 md:mt-8 lg:mt-12">
            <input
